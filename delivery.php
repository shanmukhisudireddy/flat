            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=order_hist">Your Orders</a></li>
...
$user_login = $_SESSION['login_last_name'];
$order_id = $o_id;
...
$insert_query = "INSERT INTO delivery (user_login,order_id,bill_amnt,dstn_addr,delivery_time,order_status,order_date) VALUES ('$user_login','$order_id','$bill_amnt','$dstn_addr','$delivery_time','$order_status','$date')";
                  ...
                  <div class="horizontal-timeline">
                    <ul class="list-inline items d-flex justify-content-between">
                      <li class="list-inline-item items-list">
                        <p id=1 class="py-1 px-2 rounded" style="color: #ffffff; background:#f37a27">Order placed</p>
                      </li>
                      <li class="list-inline-item items-list">
...
function myLoop() {         //  create a loop function
  var orderIdVar = "<?php echo $order_id; ?>"
  setTimeout(function() {   //  call a 3s setTimeout when the loop is called
    document.getElementById(i).style.color = '#ffffff'
    document.getElementById(i).style.backgroundColor = '#f37a27'
       //  your code here
    var orderStatus = document.getElementById(i).innerHTML
    var xmlhttp = new XMLHttpRequest();
    xmlhttp.open("GET", "delivery_update.php?order_id=" + orderIdVar + "&order_status=" + orderStatus)
    xmlhttp.send()
